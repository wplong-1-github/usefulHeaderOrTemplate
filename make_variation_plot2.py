...
def getHistogram(oneHistName):
    ...
    inputDirNominal="/home/peilong/Downloads/hist_generated/output_1Lep_410501.root"
...
def makeComparisonHistogram(oneHistName, histograms):
    ...
    colors = [2,1,3,4,6,8,8,38,38]
    leg = TLegend(0.7, 0.73, 0.9, 0.93)
    sampleName=["aMc@NloPythia8", "PowhegPythia8 (nominal)", "PowhegPythia8 radUp", "PowhegPythia8 radLo", "PowhegHerwig7", "Uncertainty from mBB", "Uncertainty from pTV"]
    ...
    for i, h in enumerate(histograms):
        ...
        if i < 5 :
            ...
            leg.AddEntry(hNew,sampleName[5])
        elif i == 7:
            leg.AddEntry(hNew,sampleName[6])
